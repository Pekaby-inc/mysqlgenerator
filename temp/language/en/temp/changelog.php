...
<main>
  <div class="wrapper">
    <div class="container">
      <div class="title">Update from 5.08.2020</div>
      <div class="body_cont">
        <p class="sc">-Redesign.</p>
        <p class="sc">-Account system.</p>
        <p class="sc">-The Japanese language added.</p>
        <p class="sc">-Fixed bug with «'» in the name field</p>
        <p class="sc">-Anything else done to the cat.</p>
      </div>
      <hr class="hr_chng">
    </div>
